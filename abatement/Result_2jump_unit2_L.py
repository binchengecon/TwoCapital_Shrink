...
parser.add_argument("--psi0",type=float)
parser.add_argument("--psi1",type=float)
...
def graph_unit(psi_0,psi_1,xi_a,xi_g,Ig_initial = 1/120):
    ...
    def graph_solution_extraction(res):
        ...
        File_Dir = args.pdfname+",xi_a={:.3f},xi_g={:.3f},psi0={:.3f},psi1={:.3f}" .format(xi_a,xi_g,psi_0,psi_1) 
        
        pdf_pages = PdfPages(PDF_Dir+File_Dir+',Years='+str(IntPeriod)+'.pdf')
        ...
        axs1[0].plot(res["years"], (res["x"]/(alpha*np.exp(res["states"][:,0])))*100,label=r'$\psi_0=$'+str(psi_0)+'$\psi_1=$'+str(psi_1),linewidth=7.0)
        ...
        axs1[1].plot(res["years"], res["i"],label=r'$\psi_0=$'+str(psi_0)+'$\psi_1=$'+str(psi_1),linewidth=7.0)
        ...
        axs1[2].plot(res["years"], res["e"],label=r'$\psi_0=$'+str(psi_0)+'$\psi_1=$'+str(psi_1),linewidth=7.0)
        ...
        axs2[0].plot(res["years"], res["states"][:, 1],label=r'$\psi_0=$'+str(psi_0)+'$\psi_1=$'+str(psi_1),linewidth=7.0)
        ...
        axs2[1].plot(res["years"], np.exp(res["states"][:, 2]),label=r'$\psi_0=$'+str(psi_0)+'$\psi_1=$'+str(psi_1),linewidth=7.0)
        ...
        axs3[0].plot(res["years"], res["distorted_tech_prob"],label=r'$\psi_0=$'+str(psi_0)+'$\psi_1=$'+str(psi_1),linewidth=7.0)
        ...
        axs3[1].plot(res["years"], res["distorted_damage_prob"],label=r'$\psi_0=$'+str(psi_0)+'$\psi_1=$'+str(psi_1),linewidth=7.0)
        ...
        axs5[0].plot(res["years"], res["true_tech_prob"],label=r'$\psi_0=$'+str(psi_0)+'$\psi_1=$'+str(psi_1),linewidth=7.0)
        ...
        axs5[1].plot(res["years"], res["true_damage_prob"],label=r'$\psi_0=$'+str(psi_0)+'$\psi_1=$'+str(psi_1),linewidth=7.0)
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/RD,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.pdf".format(xi_a,xi_g,psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/RD,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.png".format(xi_a,xi_g,psi_0,psi_1))
        plt.close()
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/CapI,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.pdf".format(xi_a,xi_g,psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/CapI,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.png".format(xi_a,xi_g,psi_0,psi_1))
        plt.close()
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/E,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.pdf".format(xi_a,xi_g,psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/E,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.png".format(xi_a,xi_g,psi_0,psi_1))
        plt.close()
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TA,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.pdf".format(xi_a,xi_g,psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TA,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.png".format(xi_a,xi_g,psi_0,psi_1))
        plt.close()
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/Ig,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.pdf".format(xi_a,xi_g,psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/Ig,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.png".format(xi_a,xi_g,psi_0,psi_1))
        plt.close()
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIgd,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.pdf".format(xi_a,xi_g,psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIgd,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.png".format(xi_a,xi_g,psi_0,psi_1))
        plt.close()
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIdd,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.pdf".format(xi_a,xi_g,psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIdd,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.png".format(xi_a,xi_g,psi_0,psi_1))
        plt.close()
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPIg,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.pdf".format(xi_a,xi_g,psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPIg,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.png".format(xi_a,xi_g,psi_0,psi_1))
        plt.close()
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPId,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.pdf".format(xi_a,xi_g,psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPId,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.png".format(xi_a,xi_g,psi_0,psi_1))
        plt.close()
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/Gamma3,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.pdf".format(xi_a,xi_g,psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/Gamma3,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.png".format(xi_a,xi_g,psi_0,psi_1))
        plt.close()
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.pdf".format(xi_a,xi_g,psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f}_L.png".format(xi_a,xi_g,psi_0,psi_1))
        plt.close()
...
graph_unit(psi_0,psi_1,xi_a,xi_g)
