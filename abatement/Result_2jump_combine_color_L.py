    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"], (res["x"]/(alpha*np.exp(res["states"][:,0])))*100,label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
            plt.xlabel('Years')
            plt.ylabel('$\%$ of GDP')
            plt.ylim(0,0.8)
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/RD,xia={},xig={},psi0={},psi1={}_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/RD,xia={},xig={},psi0={},psi1={}_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/CapI,xia={},xig={},psi0={},psi1={}_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/CapI,xia={},xig={},psi0={},psi1={}_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"], res["e"],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/E,xia={},xig={},psi0={},psi1={}_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/E,xia={},xig={},psi0={},psi1={}_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"], res["states"][:, 1],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TA,xia={},xig={},psi0={},psi1={}_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TA,xia={},xig={},psi0={},psi1={}_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"], np.exp(res["states"][:, 2]),label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/Ig,xia={},xig={},psi0={},psi1={}_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/Ig,xia={},xig={},psi0={},psi1={}_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"], res["distorted_tech_prob"],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIgd,xia={},xig={},psi0={},psi1={}_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIgd,xia={},xig={},psi0={},psi1={}_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"], res["distorted_damage_prob"],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIdd,xia={},xig={},psi0={},psi1={}_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIdd,xia={},xig={},psi0={},psi1={}_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"], res["true_tech_prob"],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPIg,xia={},xig={},psi0={},psi1={}_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPIg,xia={},xig={},psi0={},psi1={}_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"], res["true_damage_prob"],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPId,xia={},xig={},psi0={},psi1={}_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPId,xia={},xig={},psi0={},psi1={}_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"], res["scc"],label='baseline' ,linewidth=5.0)
            else:
                plt.plot(res["years"], res["scc"],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/SCC,xia={},xig={},psi0={},psi1={}_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/SCC,xia={},xig={},psi0={},psi1={}_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"][res["states"][:, 1]<1.5], ((res["x"]/(alpha*np.exp(res["states"][:,0])))*100)[res["states"][:, 1]<1.5],label='baseline' ,linewidth=5.0)
            else:
                plt.plot(res["years"][res["states"][:, 1]<1.5], ((res["x"]/(alpha*np.exp(res["states"][:,0])))*100)[res["states"][:, 1]<1.5],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
            plt.xlabel('Years')
            plt.ylabel('$\%$ of GDP')
            plt.ylim(0,0.65)
            plt.legend(loc='upper left')        

plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/RD,xia={},xig={},psi0={},psi1={},BC_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/RD,xia={},xig={},psi0={},psi1={},BC_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["i"][res["states"][:, 1]<1.5],label='baseline' ,linewidth=5.0)
            else:
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/CapI,xia={},xig={},psi0={},psi1={},BC_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/CapI,xia={},xig={},psi0={},psi1={},BC_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["e"][res["states"][:, 1]<1.5],label='baseline' ,linewidth=5.0 )
            else:
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["e"][res["states"][:, 1]<1.5],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
            # plt.plot(res2["years"][res2["states"][:, 1]<1.5], res2["e"][res2["states"][:, 1]<1.5],label=r'$\xi_p=\\xi_g=0.050$',linewidth=7.0)
            # plt.plot(res3["years"][res3["states"][:, 1]<1.5], res3["e"][res3["states"][:, 1]<1.5],label='baseline',linewidth=7.0)
            plt.xlabel('Years')
            plt.ylim(4,14)
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/E,xia={},xig={},psi0={},psi1={},BC_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["states"][:, 1][res["states"][:, 1]<1.5],label='baseline' ,linewidth=5.0 )
            else:
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["states"][:, 1][res["states"][:, 1]<1.5],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
            # plt.plot(res2["years"][res2["states"][:, 1]<1.5], res2["states"][:, 1][res2["states"][:, 1]<1.5],label=r'$\xi_p=\\xi_g=0.050$',linewidth=7.0)
            # plt.plot(res3["years"][res3["states"][:, 1]<1.5], res3["states"][:, 1][res3["states"][:, 1]<1.5],label='baseline',linewidth=7.0)
            plt.xlabel('Years')
            plt.ylim(1,2.8)
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TA,xia={},xig={},psi0={},psi1={},BC_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"][res["states"][:, 1]<1.5], np.exp(res["states"][:, 2])[res["states"][:, 1]<1.5],label='baseline' ,linewidth=5.0)
            else:
                plt.plot(res["years"][res["states"][:, 1]<1.5], np.exp(res["states"][:, 2])[res["states"][:, 1]<1.5],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
            # plt.plot(res2["years"][res2["states"][:, 1]<1.5], np.exp(res2["states"][:, 2])[res2["states"][:, 1]<1.5],label=r'$\xi_p=\\xi_g=0.050$',linewidth=7.0)
            # plt.plot(res3["years"][res3["states"][:, 1]<1.5], np.exp(res3["states"][:, 2])[res3["states"][:, 1]<1.5],label='baseline',linewidth=7.0)
            plt.xlabel('Years')
            plt.ylim(0,0.23)
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/Ig,xia={},xig={},psi0={},psi1={},BC_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/Ig,xia={},xig={},psi0={},psi1={},BC_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["distorted_tech_prob"][res["states"][:, 1]<1.5],label='baseline' ,linewidth=5.0)
            else:
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["distorted_tech_prob"][res["states"][:, 1]<1.5],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
            # plt.plot(res2["years"], res2["distorted_tech_prob"],label=r'$\xi_p=\\xi_g=0.050$',linewidth=7.0)
            # plt.plot(res3["years"], res3["distorted_tech_prob"],label='baseline',linewidth=7.0)
            plt.xlabel('Years')
            plt.ylim(0,1)
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIgd,xia={},xig={},psi0={},psi1={},BC_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIgd,xia={},xig={},psi0={},psi1={},BC_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["distorted_damage_prob"][res["states"][:, 1]<1.5],label='baseline' ,linewidth=5.0 )
            else:
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["distorted_damage_prob"][res["states"][:, 1]<1.5],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
            # plt.plot(res2["years"], res2["distorted_damage_prob"],label=r'$\xi_p=\\xi_g=0.050$',linewidth=7.0)
            # plt.plot(res3["years"], res3["distorted_damage_prob"],label='baseline',linewidth=7.0)
            plt.xlabel('Years')
            plt.ylim(0,1)
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIdd,xia={},xig={},psi0={},psi1={},BC_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIdd,xia={},xig={},psi0={},psi1={},BC_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["true_tech_prob"][res["states"][:, 1]<1.5],label='baseline' ,linewidth=5.0 )
            else:

                plt.plot(res["years"][res["states"][:, 1]<1.5], res["true_tech_prob"][res["states"][:, 1]<1.5],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )

            plt.xlabel("Years")
            plt.ylim(0,1)
            plt.legend(loc='upper left')

plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPIg,xia={},xig={},psi0={},psi1={},BC_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPIg,xia={},xig={},psi0={},psi1={},BC_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["true_damage_prob"][res["states"][:, 1]<1.5],label='baseline' ,linewidth=5.0)
            else:
 
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["true_damage_prob"][res["states"][:, 1]<1.5],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )

            plt.xlabel("Years")
            plt.ylim(0,1)
            plt.legend(loc='upper left')

plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPId,xia={},xig={},psi0={},psi1={},BC_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPId,xia={},xig={},psi0={},psi1={},BC_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            if xiaarr[id_xiag]>10:
                ...
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["scc"][res["states"][:, 1]<1.5],label='baseline' ,linewidth=5.0 )
            else:
                plt.plot(res["years"][res["states"][:, 1]<1.5], res["scc"][res["states"][:, 1]<1.5],label='$\\xi_p={:.4f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0 )
            plt.xlabel("Years")
            plt.ylim(0,250)
            plt.legend(loc='upper left')

plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/SCC,xia={},xig={},psi0={},psi1={},BC_v2_L.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/SCC,xia={},xig={},psi0={},psi1={},BC_v2_L.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
