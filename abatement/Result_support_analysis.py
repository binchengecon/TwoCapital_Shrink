...
def extract(
    ...
    return res_tpset_paru, res_tpset_nou, res_base_paru, res_base_nou, model_tech1_pre_damage, K, Y, L, Y_short
...
def model_extract(grid=(),
    ...
    res_tpset_paru, res_tpset_nou, res_base_paru, res_base_nou, model_tech1_pre_damage, K, Y, L, Y_short = extract(grid = grid_UD,
