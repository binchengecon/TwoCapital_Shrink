...
def graph_unit(psi_0,psi_1,Ig_initial = 1/120):
    ...
    def graph_solution_extraction(res):
        ...
        File_Dir = args.pdfname+",psi0={:.3f},psi1={:.3f}" .format(psi_0,psi_1) 
        ...
        plt.plot(res["years"], (res["x"]/(alpha*np.exp(res["states"][:,0])))*100,label='$\psi_0=${:.3f},$\psi_1=${:.1f}' .format(psi_0,psi_1)  )
        plt.grid(linestyle=':')
        plt.xlabel('Years')
        plt.ylabel('$\%$ of GDP')
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/RD,psi0={:.3f},psi1={:.3f}.png".format(psi_0,psi_1))
        plt.close()
    

        plt.plot(res["years"], res["i"],label='$\psi_0=${:.3f},$\psi_1=${:.1f}' .format(psi_0,psi_1)  )
        plt.xlabel('Years')
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/CapI,psi0={:.3f},psi1={:.3f}.pdf".format(psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/CapI,psi0={:.3f},psi1={:.3f}.png".format(psi_0,psi_1))
        plt.close()

        plt.plot(res["years"], res["e"],label='$\psi_0=${:.3f},$\psi_1=${:.1f}' .format(psi_0,psi_1)  )
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/E,psi0={:.3f},psi1={:.3f}.pdf".format(psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/E,psi0={:.3f},psi1={:.3f}.png".format(psi_0,psi_1))
        plt.close()

        
        plt.plot(res["years"], res["states"][:, 1],label='$\psi_0=${:.3f},$\psi_1=${:.1f}' .format(psi_0,psi_1)  )
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TA,psi0={:.3f},psi1={:.3f}.pdf".format(psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TA,psi0={:.3f},psi1={:.3f}.png".format(psi_0,psi_1))
        plt.close()

        plt.plot(res["years"], np.exp(res["states"][:, 2]),label='$\psi_0=${:.3f},$\psi_1=${:.1f}' .format(psi_0,psi_1)  )
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/Ig,psi0={:.3f},psi1={:.3f}.pdf".format(psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/Ig,psi0={:.3f},psi1={:.3f}.png".format(psi_0,psi_1))
        plt.close()


        plt.plot(res["years"], res["distorted_tech_prob"],label='$\psi_0=${:.3f},$\psi_1=${:.1f}' .format(psi_0,psi_1)  )
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIgd,psi0={:.3f},psi1={:.3f}.pdf".format(psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIgd,psi0={:.3f},psi1={:.3f}.png".format(psi_0,psi_1))
        plt.close()

        plt.plot(res["years"], res["distorted_damage_prob"],label='$\psi_0=${:.3f},$\psi_1=${:.1f}' .format(psi_0,psi_1)  )
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIdd,psi0={:.3f},psi1={:.3f}.pdf".format(psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/PIdd,psi0={:.3f},psi1={:.3f}.png".format(psi_0,psi_1))
        plt.close()


        plt.plot(res["years"], res["true_tech_prob"],label='$\psi_0=${:.3f},$\psi_1=${:.1f}' .format(psi_0,psi_1)  )
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPIg,psi0={:.3f},psi1={:.3f}.pdf".format(psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPIg,psi0={:.3f},psi1={:.3f}.png".format(psi_0,psi_1))
        plt.close()


        plt.plot(res["years"], res["true_damage_prob"],label='$\psi_0=${:.3f},$\psi_1=${:.1f}' .format(psi_0,psi_1)  )
        ...
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPId,psi0={:.3f},psi1={:.3f}.pdf".format(psi_0,psi_1))
        plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/TPId,psi0={:.3f},psi1={:.3f}.png".format(psi_0,psi_1))
        plt.close()


    res=(model_solution_extraction(1000.,1000.,psi_0,psi_1))

    graph_solution_extraction(res)



graph_unit(psi_0,psi_1)
