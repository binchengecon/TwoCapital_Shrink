...
def simulate_pre_UD(
    ...
    ME_notemp = minimize_pi_c(grid, args, n_bar1, variable_args, controls, tol=1e-6, epsilon=0.3, max_iter=10000) # n_bar free
    ME_notemp2 = minimize_pi_c(grid, args, n_bar2, variable_args, controls, tol=1e-6, epsilon=0.3, max_iter=10000) #n_bar hit 2
    ...
    ME_nocarb = minimize_pi_c(grid, args, n_bar1, variable_args, controls, tol=1e-6, epsilon=0.3, max_iter=10000) # n_bar free
    ME_nocarb2 = minimize_pi_c(grid, args, n_bar2, variable_args, controls, tol=1e-6, epsilon=0.3, max_iter=10000) #n_bar hit 2
    ...
    variable_args = (theta_ell_wakeup, psi_2_wakeup)
    controls=(ii,ee,xx, g_tech, g_damage,  pi_c_o_wakeup, pi_c_wakeup, pi_d_o_wakeup, v0, v_i, v_tech2)
    ME_nodmg = minimize_pi_c(grid, args, n_bar1, variable_args, controls, tol=1e-6, epsilon=0.3, max_iter=10000) # n_bar free
    ME_nodmg2 = minimize_pi_c(grid, args, n_bar2, variable_args, controls, tol=1e-6, epsilon=0.3, max_iter=10000) #n_bar hit 2
    ...
    variable_args = (theta_ell_wakeup, psi_2_wakeup)
    controls=(ii,ee,xx, g_tech, g_damage,  pi_c_o_wakeup, pi_c_wakeup, pi_d_o_wakeup, v0, v_i, v_tech2)
    ME_notech = minimize_pi_c(grid, args, n_bar1, variable_args, controls, tol=1e-6, epsilon=0.3, max_iter=10000) # n_bar free
    ME_notech2 = minimize_pi_c(grid, args, n_bar2, variable_args, controls, tol=1e-6, epsilon=0.3, max_iter=10000) #n_bar hit 2
