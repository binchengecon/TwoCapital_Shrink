...
parser.add_argument("--xiparr",nargs='+',type=float)
...
xi_a_grid = args.xiaarr
xi_p_grid = args.xiparr
...
def graph2(psi_0_meshgrid_1d,psi_1_meshgrid_1d,xi_a_grid,xi_p_grid,Ig_initial = 1/120):
    ...
    for psi_0,psi_1 in zip(psi_0_meshgrid_1d,psi_1_meshgrid_1d):
        for xi_a,xi_p in zip(xi_a_grid,xi_p_grid):
