...
# plt.plot(x_mat_1d, y_mat_1d, "ok", label="input point")
# plt.legend()
# plt.colorbar()
# plt.axis("equal")
# plt.savefig("./abatement/pdf_2tech/interpolate/test.pdf")
# plt.clf()
...
# plt.colorbar()
# plt.axis("equal")
# plt.savefig("./abatement/pdf_2tech/interpolate/test2.pdf")
