...
parser.add_argument("--psi_0", type=float, default=0.008)
parser.add_argument("--psi_1", type=float, default=0.8)
parser.add_argument("--num_gamma",type=int,default=3)
parser.add_argument("--name",type=str,default="2jump_step0.05verify_smartwithintstep0.2_Linear")
parser.add_argument("--hXarr",nargs='+',type=float, default=(0.1, 0.1, 0.1))
parser.add_argument("--Xminarr",nargs='+',type=float, default=(4.0, 0.0, -5.5, 0.0))
parser.add_argument("--Xmaxarr",nargs='+',type=float, default=(9.0, 4.0, 0.0, 3.0))
parser.add_argument("--epsilonarr",nargs='+',type=float, default=(0.1, 0.01))
parser.add_argument("--fractionarr",nargs='+',type=float, default=(0.1, 0.01))
parser.add_argument("--maxiterarr",nargs='+',type=int, default=(10, 10))
...
# Guess_interpolated = pickle.load(open(Data_Dir+ File_Name  +"SG_model_tech1_post_damage_gamma_{:.4f}".format(gamma_3_i), "rb"))

# print(np.max(Guess_interpolated["x_star"]))
