        ...
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["ME_total"]/res["ME_base"])*100,label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
                else:
                    plt.plot(res["years"], np.log(res["ME_total"]/res["ME_base"])*100,label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["ME_temp"]/res["ME_base"])*100,label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
                else:
                    plt.plot(res["years"], np.log(res["ME_temp"]/res["ME_base"])*100,label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["ME_carb"]/res["ME_base"])*100,label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
                else:
                    plt.plot(res["years"], np.log(res["ME_carb"]/res["ME_base"])*100,label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["ME_RD"]/res["ME_base"])*100,label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
                else:
                    plt.plot(res["years"], np.log(res["ME_RD"]/res["ME_base"])*100,label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["ME_dmg"]/res["ME_base"])*100,label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
                else:
                    plt.plot(res["years"], np.log(res["ME_dmg"]/res["ME_base"])*100,label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["ME_tech"]/res["ME_base"])*100,label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
                else:
                    plt.plot(res["years"], np.log(res["ME_tech"]/res["ME_base"])*100,label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["ME_notemp"]/res["ME_base"])*100,label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
                else:
                    plt.plot(res["years"], np.log(res["ME_notemp"]/res["ME_base"])*100,label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["ME_nocarb"]/res["ME_base"])*100,label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
                else:
                    plt.plot(res["years"], np.log(res["ME_nocarb"]/res["ME_base"])*100,label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["ME_noRD"]/res["ME_base"])*100,label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
                else:
                    plt.plot(res["years"], np.log(res["ME_noRD"]/res["ME_base"])*100,label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["ME_nodmg"]/res["ME_base"])*100,label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
                else:
                    plt.plot(res["years"], np.log(res["ME_nodmg"]/res["ME_base"])*100,label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
        ...
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["ME_notech"]/res["ME_base"])*100,label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
                else:
                    plt.plot(res["years"], np.log(res["ME_notech"]/res["ME_base"])*100,label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
...
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_carb_base"][res["states"][:, 1]<1.5]),label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
#                 else:
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_carb_base"][res["states"][:, 1]<1.5]),label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
#                 plt.xlabel("Years")
#                 plt.ticklabel_format(useOffset=False)
...
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_RD_base"][res["states"][:, 1]<1.5]),label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
#                 else:
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_RD_base"][res["states"][:, 1]<1.5]),label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
#                 plt.xlabel("Years")
#                 plt.ticklabel_format(useOffset=False)
...
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_dmg_base"][res["states"][:, 1]<1.5]),label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
#                 else:
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_dmg_base"][res["states"][:, 1]<1.5]),label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
#                 plt.xlabel("Years")
#                 plt.ticklabel_format(useOffset=False)
...
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_tech_base"][res["states"][:, 1]<1.5]),label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
#                 else:
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_tech_base"][res["states"][:, 1]<1.5]),label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
#                 plt.xlabel("Years")
#                 plt.ticklabel_format(useOffset=False)
...
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_notemp_base"][res["states"][:, 1]<1.5]),label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
#                 else:
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_notemp_base"][res["states"][:, 1]<1.5]),label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
#                 plt.xlabel("Years")
#                 plt.ticklabel_format(useOffset=False)
...
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_nocarb_base"][res["states"][:, 1]<1.5]),label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
#                 else:
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_nocarb_base"][res["states"][:, 1]<1.5]),label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
#                 plt.xlabel("Years")
#                 plt.ticklabel_format(useOffset=False)
...
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_noRD_base"][res["states"][:, 1]<1.5]),label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
#                 else:
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_noRD_base"][res["states"][:, 1]<1.5]),label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
#                 plt.xlabel("Years")
#                 plt.ticklabel_format(useOffset=False)
...
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_nodmg_base"][res["states"][:, 1]<1.5]),label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
#                 else:
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_nodmg_base"][res["states"][:, 1]<1.5]),label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
#                 plt.xlabel("Years")
#                 plt.ticklabel_format(useOffset=False)
...
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_notech_base"][res["states"][:, 1]<1.5]),label='baseline'.format(psi2arr[id_psi2]) ,linewidth=5.0)
#                 else:
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["ME_notech_base"][res["states"][:, 1]<1.5]),label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag],psi2arr[id_psi2]) ,linewidth=5.0)
#                 plt.xlabel("Years")
#                 plt.ticklabel_format(useOffset=False)
