...
parser.add_argument("--psi_0", type=float, default=0.010)
parser.add_argument("--psi_1", type=float, default=0.5)
parser.add_argument("--Y_max_short", type=float, default=3.)
parser.add_argument("--name",type=str,default="ReplicateSuri")
parser.add_argument("--hK",type=float,default=0.1)
parser.add_argument("--hY",type=float,default=0.1)
parser.add_argument("--hL",type=float,default=0.1)
...
Data_Dir = "./abatement/data_2tech/suri_res_data/"

File_Name = "10damage/xi_a_1000.0_xi_g_1000.0/"
# os.makedirs(DataDir)
# if not os.path.exists(DataDir):
...
model_tech1_pre_damage = hjb_pre_tech(
        ...
        tol=1e-8, epsilon=0.01, fraction=0.1, max_iter=1,
