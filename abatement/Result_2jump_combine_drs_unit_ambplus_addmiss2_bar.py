    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                # histogram of beta_f
                theta_ell = pd.read_csv("./data/model1442_p.csv", header=None).to_numpy()[:, 0]
                # print("theta_ell")
                # print(theta_ell)
                # print("theta_ell_new")
                # print(theta_ell_new)
                ...
                plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity_0,xia={:.5f},xig={:.3f},psi0={:.3f},psi1={:.3f},psi2={:.1f},BC_v2_L.pdf".format(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1],psi2arr[id_psi2]))
                plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity_0,xia={:.5f},xig={:.3f},psi0={:.3f},psi1={:.3f},psi2={:.1f},BC_v2_L.png".format(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1],psi2arr[id_psi2]))
                plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                # theta_ell_new = res["theta_ell_new"][:,-1]
                # histogram of beta_f
                psi_2 = pd.read_csv("./data/psi2value2_p.csv", header=None).to_numpy()[:, 0]
                # print("theta_ell")
                # print(theta_ell)
                # print("theta_ell_new")
                # print(theta_ell_new)
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_psi2 in range(len(psi2arr)):
                ...
                plt.ylim(0, 1.4)
                plt.xlabel("Climate Sensitivity")
                plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity_25,xia={:.5f},xig={:.3f},psi0={:.3f},psi1={:.3f},psi2={:.1f},BC_v2_L.pdf".format(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1],psi2arr[id_psi2]))
                plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity_25,xia={:.5f},xig={:.3f},psi0={:.3f},psi1={:.3f},psi2={:.1f},BC_v2_L.png".format(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1],psi2arr[id_psi2]))
                plt.close()
...
for id_xiag in range(len(xiaarr)): 
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/Gamma3,xia={:.5f},xig={:.3f},psi0={:.3f},psi1={:.3f},psi2={:.1f},BC_v2_L.pdf".format(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1],psi2arr[id_psi2]))
            plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/Gamma3,xia={:.5f},xig={:.3f},psi0={:.3f},psi1={:.3f},psi2={:.1f},BC_v2_L.png".format(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1],psi2arr[id_psi2]))
            plt.close()
