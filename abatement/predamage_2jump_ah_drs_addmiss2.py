...
from src.solver_ah_drs_addmiss2 import pde_one_interation
from src.solver_ah_drs_addmiss2 import hjb_pre_tech
import argparse
...
parser.add_argument("--psi_2", type=float, default=0.5)
...
model_args =(delta, alpha, theta, vartheta_bar, lambda_bar, mu_k, kappa, sigma_k, theta_ell, pi_c_o, pi_c, sigma_y, zeta, psi_0, psi_1, psi_2, sigma_g, v_tech2, gamma_1, gamma_2, gamma_3_list, y_bar, xi_a, xi_g, xi_p, xi_m)
