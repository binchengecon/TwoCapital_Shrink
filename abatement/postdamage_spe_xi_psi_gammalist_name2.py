...
# my version: comment to be in line with suri's result
...
# originally, in parallel, we made gamma_3_i instead of 0
# model_args = (delta, alpha, kappa, mu_k, sigma_k, theta_ell, pi_c_o, 
#             sigma_y, xi_a, xi_b, gamma_1, gamma_2, gamma_3_i, y_bar, 
...
# res = hjb_pre_tech(
#         state_grid=(K, Y, L), 
#         model_args=(delta, alpha, theta, vartheta_bar, 
#         lambda_bar, mu_k, kappa, sigma_k, theta_ell, 
...
res = hjb_pre_tech(
       ...
       V_post_damage=None,
       tol=1e-7, epsilon=epsilonarr[2], fraction=fractionarr[2], max_iter=maxiterarr[2],smart_guess=None,
       )
