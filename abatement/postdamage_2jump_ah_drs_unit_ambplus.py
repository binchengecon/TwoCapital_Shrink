...
from PostSolver_ah import hjb_post_damage_post_tech, hjb_pre_damage_post_tech
from src.solver_ah_drs_unit_ambplus import pde_one_interation
from src.solver_ah_drs_unit_ambplus import hjb_pre_tech
import argparse
...
theta_ell = theta_ell_mean * np.ones(K_mat.shape)
print("-------------------------------------------")
...
res = hjb_pre_tech(
        state_grid=(K, Y, L), 
        model_args=(delta, alpha, theta, vartheta_bar, lambda_bar, mu_k, kappa, sigma_k, theta_ell, pi_c_o, pi_c, sigma_y, zeta, psi_0, psi_1, psi_2, sigma_g, V_post_tech2, gamma_1, gamma_2, gamma_3_i, y_bar, xi_a, xi_g, xi_p, xi_m),
        V_post_damage=None,
