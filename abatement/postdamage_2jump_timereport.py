...
from src.solver_reportmore import pde_one_interation
from src.solver_reportmore import hjb_pre_tech
import argparse
...
parser.add_argument("--name",type=str,default="2jump_step_0.05_0.05_0.05_LR_0.007_reportmore")
parser.add_argument("--hXarr",nargs='+',type=float,default=(0.05, 0.05, 0.05))
...
parser.add_argument("--epsilonarr",nargs='+',type=float,default=(0.1, 0.007))
parser.add_argument("--fractionarr",nargs='+',type=float,default=(0.1, 0.007))
parser.add_argument("--maxiterarr",nargs='+',type=int,default=(60000, 100000))
