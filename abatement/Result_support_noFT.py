...
def simulate_UD(
    ...
    ME_SCC = ME_total2/ME_consumption * 1000
    ...
    res_base = pickle.load(open(Data_Dir+ File_Dir  + "model_tech1_pre_damage_base_scheme1_partialupdate", "rb"))
    res_base2 = pickle.load(open(Data_Dir+ File_Dir  + "model_tech1_pre_damage_base2_scheme1_partialupdate", "rb"))
    ...
    res_base2_nou = pickle.load(open(Data_Dir+ File_Dir  + "model_tech1_pre_damage_base2_scheme1_noupdate", "rb"))
