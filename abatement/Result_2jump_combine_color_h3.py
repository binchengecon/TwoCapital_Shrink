...
for id_xiag in range(len(xiaarr)): 
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            pi_c = res["pic_t"][:, 13]
            theta_ell_new = res["theta_ell_new"][:,13]
            ...
            plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity_1,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f},BC.pdf".format(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1]))
            plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity_1,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f},BC.png".format(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1]))
            plt.close()
            ...
            plt.ylim(0, 1.4)
            plt.xlabel("Climate Sensitivity")
            plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity_pmean_1,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f},BC.pdf".format(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1]))
            plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity_pmean_1,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f},BC.png".format(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1]))
            plt.close()
...
for id_xiag in range(len(xiaarr)): 
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            ...
            plt.ylim(0, 1.4)
            plt.xlabel("Climate Sensitivity")
            plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity_pmean_25,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f},BC.pdf".format(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1]))
            plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/ClimateSensitivity_pmean_25,xia={:.4f},xig={:.3f},psi0={:.3f},psi1={:.3f},BC.png".format(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1]))
            plt.close()
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/MeanDiff_25,xia={},xig={},psi0={},psi1={},BC_v2.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/MeanDiff_25,xia={},xig={},psi0={},psi1={},BC_v2.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/MeanDiff_25,xia={},xig={},psi0={},psi1={}_v2.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/MeanDiff_25,xia={},xig={},psi0={},psi1={}_v2.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/MeanDiff_h_25,xia={},xig={},psi0={},psi1={},BC_v2.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/MeanDiff_h_25,xia={},xig={},psi0={},psi1={},BC_v2.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
...
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/MeanDiff_h_25,xia={},xig={},psi0={},psi1={}_v2.pdf".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.savefig("./abatement/pdf_2tech/"+args.dataname+"/MeanDiff_h_25,xia={},xig={},psi0={},psi1={}_v2.png".format(xiaarr,xigarr,psi0arr,psi1arr))
plt.close()
