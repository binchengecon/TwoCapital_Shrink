...
python3 /home/bcheng4/TwoCapital_Shrink/abatement/$python_name --num_gamma $NUM_DAMAGE --xi_a ${xi_a[$j]} --xi_g ${xi_p[$j]}   --id $i --psi_0 $PSI_0 --psi_1 $PSI_1 --name ${action_name} --hK $hK --hY  	$hY --hL  $hL
