...
def model_simulation_generate(xi_a,xi_g,psi_0,psi_1):
    ...
    if scheme == "macroannual":
        ...
        n_bar = n_bar2
        with open(Data_Dir+ File_Dir + "model_tech1_post_damage"+File_Name_Suffix_pre, "rb") as f:
        ...
        with open(Data_Dir+ File_Dir + "model_tech1_post_damage_gamma_{:.4f}".format(gamma_3_i), "rb") as f:
            model_tech1_post_damage_ME_base = pickle.load(f)
        n_bar = n_bar1
    ME_base = model_tech1_post_damage_ME_base["ME"]


    v = model_tech1_post_damage_ME_base["v0"]
    i = model_tech1_post_damage_ME_base["i_star"]
    e = model_tech1_post_damage_ME_base["e_star"]
    x = model_tech1_post_damage_ME_base["x_star"]
    pi_c = model_tech1_post_damage_ME_base["pi_c"]
    g_tech = model_tech1_post_damage_ME_base["g_tech"]
    # g_damage =  model_tech1_post_damage_ME_base["g_damage"]
    ...
    with open(Data_Dir + File_Dir+"FK_Y_Undistorted_model_tech1_post_damage_gamma_{:.4f}".format(gamma_3_i), "rb") as f:
        FK_Y_Undis_tech1 = pickle.load(f)


    with open(Data_Dir + File_Dir+"HJB_Distorted_model_tech1_post_damage_gamma_{:.4f}".format(gamma_3_i), "rb") as f:
    ...
    with open(Data_Dir + File_Dir+"model_tech1_post_damage_gamma_{:.4f}".format(gamma_3_i)+"_FK_simul_{}".format(IntPeriod)+ scheme + "_" +HJB_solution, "wb") as f:
        pickle.dump(res,f)
