...
import src.PreSolver_RevertBack
import src.ResultSolver_RevertBack
import time
import numpy as np
import argparse
import pandas as pd
...
theta_ell = pd.read_csv('./data/model1442_p.csv', header=None).to_numpy()[:, 0]/1000.
...
if scheme == "macroannual":
    ...
    Guess = None
    model_tech1_pre_damage = src.ResultSolver_RevertBack.hjb_pre_tech_partialupdate(
...
if scheme == "newway":
    ...
    if HJB_solution=="iterative_fix":
        ...
        Guess = None
        model_tech1_pre_damage = src.ResultSolver_RevertBack.hjb_pre_tech_noupdate(
                state_grid=(K, Y_short, L), 
                model_args=model_args, 
                control_fixed=(ii, ee, xx, v0),
                n_bar = n_bar2,
    ...
    if HJB_solution=="n_iterative_fix":
        ...
        Guess = None
        model_tech1_pre_damage = src.ResultSolver_RevertBack.hjb_pre_tech_noupdate_noFT(
                state_grid=(K, Y_short, L), 
                model_args=model_args, 
                control_fixed=(ii, ee, xx, v0),
                n_bar = n_bar2,
    ...
    if HJB_solution=="iterative_partial_noFT":
        xi_a_post = 100000.
        xi_g_post = 100000.
        xi_p_post = 100000.
        File_Name_Suffix = "_xiapost_{}_xig_post_{}_xippost_{}".format(xi_a_post, xi_g_post, xi_p_post) + "_full_" + scheme + "_" +HJB_solution
        ...
        Guess = None
        model_tech1_pre_damage = src.ResultSolver_RevertBack.hjb_pre_tech_partialupdate_noFT(
                state_grid=(K, Y_short, L), 
                model_args=model_args, 
                control_fixed=(ii, ee, xx, v0),
                n_bar = n_bar2,
