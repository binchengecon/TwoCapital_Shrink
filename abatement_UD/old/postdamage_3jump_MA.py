...
res_i = pickle.load(open(Data_Dir+ File_Name  + "model_tech2_post_damage_gamma_{:.4f}".format(gamma_3_i), "rb"))
...
res = hjb_pre_tech(
       state_grid=(K, Y, L),
       model_args=(delta, alpha, theta, vartheta_bar, lambda_bar, mu_k, kappa, sigma_k, theta_ell, pi_c_o, pi_c, sigma_y, zeta, psi_0, psi_1, psi_2, sigma_g, V_post_tech1, gamma_1, gamma_2, gamma_3_i, y_bar, xi_a, xi_g, xi_p),
       V_post_damage=None,
        tol=1e-7, epsilon=epsilonarr[2], fraction=fractionarr[2], 
        smart_guess=Guess, 
        max_iter=maxiterarr[2],
       )
