...
if scheme=="macroannual":
    ...
    res = src.PreSolver_RevertBack.hjb_pre_tech(
            state_grid=(K, Y, L), 
...
if scheme=="newway":
    ...
    if HJB_solution=="iterative_partial":
        ...
        res = src.ResultSolver_RevertBack.hjb_pre_tech_partialupdate(
                state_grid=(K, Y, L), 
    ...
    if HJB_solution=="iterative_fix":
        ...
        res = src.ResultSolver_RevertBack.hjb_pre_tech_noupdate(
                state_grid=(K, Y, L), 
                model_args=(delta, alpha, theta, vartheta_bar, lambda_bar, mu_k, kappa, sigma_k, theta_ell, sigma_y, zeta, psi_0, psi_1, psi_2, sigma_g, V_post_tech2, gamma_1, gamma_2, gamma_3_i, y_bar, xi_a_post, xi_g_post, xi_p_post),
                control_fixed=(ii, ee, xx, v0),
                n_bar = n_bar,
    ...
    if HJB_solution=="n_iterative_fix":
        ...
        Guess = None
        n_bar = len(Y)-1
        res = src.ResultSolver_RevertBack.hjb_pre_tech_noupdate_noFT(
                state_grid=(K, Y, L), 
                model_args=(delta, alpha, theta, vartheta_bar, lambda_bar, mu_k, kappa, sigma_k, theta_ell, sigma_y, zeta, psi_0, psi_1, psi_2, sigma_g, V_post_tech2, gamma_1, gamma_2, gamma_3_i, y_bar, xi_a_post, xi_g_post, xi_p_post),
                control_fixed=(ii, ee, xx, v0),
                n_bar = n_bar,
