...
print(res.keys())
plt.savefig(Plot_Dir+"/RDDistorted_"+Filename+'.pdf')
plt.savefig(Plot_Dir+"/RDDistorted_"+Filename+".png")
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], (((res["x"]/(alpha*np.exp(res["states"][:,0])))*100)*(1-res["distorted_tech_prob"]))[res["states"][:, 1]<1.5],label=labellist[id_xiag],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], (((res["x"]/(alpha*np.exp(res["states"][:,0])))*100)*(1-res["distorted_tech_prob"]))[res["states"][:, 1]<1.5],label=labellist[id_xiag] ,linewidth=5.0)
                plt.xlabel('Years')
                plt.ylabel('$\%$ of GDP')
                ...
                plt.legend(loc='upper left')        
print(res.keys())
plt.savefig(Plot_Dir+"/RDDistorted_Expected_"+Filename+'.pdf')
plt.savefig(Plot_Dir+"/RDDistorted_Expected_"+Filename+".png")
plt.close()
...
plt.savefig(Plot_Dir+"/EDistorted_"+Filename+'.pdf')
plt.savefig(Plot_Dir+"/EDistorted_"+Filename+".png")
plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                if xiaarr[id_xiag]>10:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], ( res["e"] * (1-res["distorted_tech_prob"]) )[res["states"][:, 1]<1.5] ,label=labellist[id_xiag],linewidth=5.0)
                else:
                    plt.plot(res["years"][res["states"][:, 1]<1.5], ( res["e"] * (1-res["distorted_tech_prob"]) )[res["states"][:, 1]<1.5] ,label=labellist[id_xiag] ,linewidth=5.0)
                # plt.plot(res2["years"][res2["states"][:, 1]<1.5], res2["e"][res2["states"][:, 1]<1.5],label=r'$\xi_a=\\xi_g=0.050$',linewidth=7.0)
                # plt.plot(res3["years"][res3["states"][:, 1]<1.5], res3["e"][res3["states"][:, 1]<1.5],label=labellist[id_xiag],linewidth=7.0)
...
plt.savefig(Plot_Dir+"/EDistorted_Expected_"+Filename+'.pdf')
plt.savefig(Plot_Dir+"/EDistorted_Expected_"+Filename+".png")
plt.close()
...
# plt.savefig(Plot_Dir+"/ComposE_ExpectedDistorted_"+Filename+'.pdf')
# plt.savefig(Plot_Dir+"/ComposE_ExpectedDistorted_"+Filename+".png")
# plt.close()
...
# plt.savefig(Plot_Dir+"/TADistorted_"+Filename+'.pdf')
# plt.savefig(Plot_Dir+"/TADistorted_"+Filename+".png")
# plt.close()
...
plt.savefig(Plot_Dir+"/ProbTechJumpDistorted_"+Filename+'.pdf')
plt.savefig(Plot_Dir+"/ProbTechJumpDistorted_"+Filename+".png")
plt.close()
...
plt.savefig(Plot_Dir+"/ProbDamageChangeDistorted_"+Filename+'.pdf')
plt.savefig(Plot_Dir+"/ProbDamageChangeDistorted_"+Filename+".png")
plt.close()
...
plt.savefig(Plot_Dir+"/logSCCDistorted_"+Filename+'.pdf')
plt.savefig(Plot_Dir+"/logSCCDistorted_"+Filename+".png")
plt.close()
...
plt.savefig(Plot_Dir+"/logSVRDDistorted_"+Filename+'.pdf')
plt.savefig(Plot_Dir+"/logSVRDDistorted_"+Filename+".png")
plt.close()
...
# #                     plt.plot(res["years"], np.log(res["scrd_dis"]),label=labellist[id_xiag],linewidth=5.0)
# #                 else:
# #                     plt.plot(res["years"], np.log(res["scrd_dis"]),label=labellist[id_xiag] ,linewidth=5.0)
...
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["scrd_undis"])[res["states"][:, 1]<1.5],label=labellist[id_xiag],linewidth=5.0)
#                 else:
#                     plt.plot(res["years"][res["states"][:, 1]<1.5], np.log(res["scrd_undis"])[res["states"][:, 1]<1.5],label=labellist[id_xiag] ,linewidth=5.0)
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                plt.savefig(Plot_Dir+"/Gamma3Distorted_"+Filename+labellist[id_xiag]+".png")
                plt.savefig(Plot_Dir+"/Gamma3Distorted_"+Filename+labellist[id_xiag]+".pdf")
                plt.close()
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
            for id_varrho in range(len(varrhoarr)):
                ...
                plt.ylim(0, 1.4)
                plt.xlabel("Climate Sensitivity")
                plt.savefig(Plot_Dir+"/ClimateSensitivity_pmean_{}Distorted_".format(IntPeriod)+Filename+labellist[id_xiag]+".pdf")
                plt.savefig(Plot_Dir+"/ClimateSensitivity_pmean_{}Distorted_".format(IntPeriod)+Filename+labellist[id_xiag]+".png")
                plt.close()
