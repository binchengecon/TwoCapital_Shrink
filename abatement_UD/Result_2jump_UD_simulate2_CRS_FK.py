...
def simulate_pre(
    ...
    xx = xx[:,:n_bar,:]
    g_tech = g_tech[:,:n_bar,:]
    g_damage = g_damage[:,:,:n_bar,:]
    pi_c = pi_c[:,:,:n_bar,:]
    v = v[:,:n_bar,:]
    
    ME_base = ME_base[:,:n_bar,:]
    
    dvdL_dis = dvdL_dis[:,:n_bar,:]
    dvdL_undis = dvdL_undis[:,:n_bar,:]
    dvdL_dis_HJB = dvdL_dis_HJB[:,:n_bar,:]
    dvdL_Undis_HJB = dvdL_Undis_HJB[:,:n_bar,:]
    dvdL_Undis_HJB_New = dvdL_Undis_HJB_New[:,:n_bar,:]
    dvdY_dis = dvdY_dis[:,:n_bar,:]
    ddvddY_dis = ddvddY_dis[:,:n_bar,:]
    dvdY_undis = dvdY_undis[:,:n_bar,:]
    ddvddY_undis = ddvddY_undis[:,:n_bar,:]
