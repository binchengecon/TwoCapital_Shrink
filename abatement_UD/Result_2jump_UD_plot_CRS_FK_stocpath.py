...
def model_simulation_total(xi_a,xi_g,psi_0,psi_1):
...
def model_simulation_var(xi_a,xi_g,psi_0,psi_1, varname):
    ...
    for sim in range(SimPathNum):
        ...
        if varname == "x":
            var_matrix[sim,:] =  (res_total[sim][varname]/(alpha*np.exp( res_total[sim]["states"][:,0])))*100
        else :
    ...
    return var_matrix90, var_matrix50, var_matrix10
...
for id_xiag in range(len(xiaarr)): 
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
                ...
                res_x90, res_x50, res_x10 = model_simulation_var(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1],"x")
...
for id_xiag in range(len(xiaarr)): 
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
                ...
                res = model_simulation_var(xiaarr[id_xiag],xigarr[id_xiag],psi0arr[id_psi0],psi1arr[id_psi1])
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["scc_undis"]),label='FK: baseline',linewidth=5.0,linestyle = 'dashed',color=color_one)
                else:
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["scc"]),label='baseline',linewidth=5.0,color=color_one)
                else:
                    plt.plot(res["years"], np.log(res["scc"]),label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0,color=color_one)
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["scc_dis"]),label='baseline',linewidth=5.0,color=color_one)
                else:
                    plt.plot(res["years"], np.log(res["scc_dis"]),label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0,color=color_one)
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["scc_dis"]),label='FK: baseline',linewidth=5.0,linestyle = 'dashed',color=color_one)
                else:
    ...
    for id_psi0 in range(len(psi0arr)):
        for id_psi1 in range(len(psi1arr)):
                ...
                if xiaarr[id_xiag]>10:
                    ...
                    plt.plot(res["years"], np.log(res["scrd_undis"]),label='baseline',linewidth=5.0,linestyle = 'dashed',color=color_one)
                else:
                    plt.plot(res["years"], np.log(res["scrd_undis"]),label='$\\xi_p={:.5f}$,$\\xi_m={:.3f}$' .format(xiaarr[id_xiag],xigarr[id_xiag]) ,linewidth=5.0,linestyle = 'dashed',color=color_one)
