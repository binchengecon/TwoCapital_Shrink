...
plt.tight_layout()
plt.savefig(Figure_Dir+"Erik.pdf")
plt.savefig(Figure_Dir+"Erik.png")
...
# axs[0].axvline(T_ol, color='k', linestyle='--')
# axs[0].axvline(T_oh, color='k', linestyle='--')
# axs[0].axvline(T_vl, color='k', linestyle='--')
# axs[0].axvline(T_vh, color='k', linestyle='--')
# axs[0].axhline(C0, color='k', linestyle='--')
# axs[0].text(T_ol, 1.01 * C_values[-1], r'$T_{o,l}$', horizontalalignment='center', fontsize='x-large')
# axs[0].text(T_oh, 1.01 * C_values[-1], r'$T_{o,h}$', horizontalalignment='center', fontsize='x-large')
# axs[0].text(T_vh, 1.01 * C_values[-1], r'$T_{v,h}$', horizontalalignment='center', fontsize='x-large')
# axs[0].text(T_vl, 1.01 * C_values[-1], r'$T_{v,l}$', horizontalalignment='center', fontsize='x-large')
