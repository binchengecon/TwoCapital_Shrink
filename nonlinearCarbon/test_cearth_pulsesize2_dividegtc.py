...
def model(time, pulse, cearth):
    ...
    # Cs = C0
    init = [Ts, Cs]
    t_eval = np.linspace(0, tspan, 5000)
    ...
    return tv+1800, Tvmid, Cv, T+1800, Cc, file_name, bP, bB, cearth


Figure_Dir = "./nonlinearCarbon/figure/cearth_pulsesize6/"
...
for cearth in ceartharray:
    ...
    for pulse in pulsearray:
        ...
        tv, Tvmid, Cv, Te, Cc, file_name, bP, bB, cearth = model(
            time, pulse, cearth)
        # print(CcBase)
        ...
        axs[0].plot(tv, Tvmid, label=f"cearth={cearth},pulse={pulse}")
        ...
        axs[1].plot(tv, Cv, label=f"cearth={cearth},pulse={pulse}")
        ...
        axs[2].plot(Te, Cc*2.13,
                    label=f"cearth={cearth},pulse={pulse}")
        ...
        axs[3].plot(tv, (Tvmid-TvmidBase)/pulse,
                    label=f"cearth={cearth},pulse={pulse}")
        # axs[3].set_ylim(-0.0015, 0.008)
        ...
        plt.savefig(Figure_Dir+"Baseline="+file_name+",cearth" +
                    str(cearth)+",year"+str(time+1800)+",pulse="+str(pulse)+",prop.pdf")
        plt.savefig(Figure_Dir+"Baseline="+file_name+",cearth=" +
    ...
    plt.savefig(Figure_Dir+"Baseline="+file_name+",cearth=" +
                           str(cearth)+",year"+str(time+1800)+",prop,back2back.png")
    plt.close()
