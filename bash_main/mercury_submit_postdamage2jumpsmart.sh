...
# I delete "2jump_step02verify_new" by accident, now let's try to use "2jump_step_0.2_0.2_0.2_LR_0.005"
...
# actiontime=90
# action_name="2jump_step_0.1_0.1_0.05_LR_${epsilon}_2"
...
# epsilon=0.01
# actiontime=91
# action_name="2jump_step_0.05_0.05_0.05_LR_${epsilon}_step0.2Near"
# python_name="postdamage_2jump_interp_SG.py"
# NUM_DAMAGE=3
# ID_MAX_DAMAGE=$((NUM_DAMAGE-1))
# epsilonarr=(0.1 ${epsilon})
...
# epsilon=0.007
# #actiontime=92, epsilon=0.01
# actiontime=93
# action_name="2jump_step_0.05_0.05_0.05_LR_${epsilon}"
# python_name="postdamage_2jump.py"
# NUM_DAMAGE=3
# ID_MAX_DAMAGE=$((NUM_DAMAGE-1))
# epsilonarr=(0.1 ${epsilon})
...
# epsilon=0.007(94), 0.01(96), 0.015(97), 0.017,(100),0.02(98)
# epsilon=0.017
# actiontime=100
# action_name="2jump_step_0.05_0.05_0.05_LR_${epsilon}_step0.2Near"
# python_name="postdamage_2jump_interp_SG.py"
...
# #actiontime=92, epsilon=0.01
# actiontime=95
# action_name="2jump_step_0.1_0.1_0.02_LR_${epsilon}"
# python_name="postdamage_2jump.py"
# NUM_DAMAGE=3
# ID_MAX_DAMAGE=$((NUM_DAMAGE-1))
# epsilonarr=(0.1 ${epsilon})
...
# epsilon=0.005
# actiontime=99
# action_name="2jump_step_0.1_0.1_0.1_LR_${epsilon}"
# python_name="postdamage_2jump.py"
# NUM_DAMAGE=3
# ID_MAX_DAMAGE=$((NUM_DAMAGE-1))
# epsilonarr=(0.1 ${epsilon})
...
# # 20 damages (105) 0.005 and 0.5 (108)
...
# epsilon=0.008(104) 0.005(supposed to be 105) 20 damages(106) 0.005 and 0.5(107)
# epsilon=0.008
# actiontime=107
# action_name="2jump_step_0.1_0.1_0.1_LR_${epsilon}"
# python_name="postdamage_2jump.py"
...
actiontime=109
action_name="2jump_step_0.05_0.05_0.05_LR_0.01_full"
python_name="postdamage_2jump_interp_SG.py"
NUM_DAMAGE=10
ID_MAX_DAMAGE=$((NUM_DAMAGE-1))
epsilonarr=(0.1 0.01)
