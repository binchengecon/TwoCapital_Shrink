...
# python_name_unit="Result_2jump_unit2.py"
python_name_unit="Result_2jump_unit2_before15.py"
server_name="mercury"
...
python3 /home/bcheng4/TwoCapital_Shrink/abatement/${python_name_unit} --dataname  ${action_name} --pdfname ${server_name} --psi0 ${PSI_0} --psi1 ${PSI_1}  --xi_a ${xi_a[$j]} --xi_g ${xi_p[$j]}   --hXarr ${hXarr[@]} --Xminarr ${Xminarr[@]} --Xmaxarr ${Xmaxarr[@]}
